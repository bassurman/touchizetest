...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'commercebanners/tmp/images/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'commercebanners/images/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'commercebanners/tmp/images/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'commercebanners/images/file';
